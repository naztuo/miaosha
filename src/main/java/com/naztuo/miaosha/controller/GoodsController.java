...
import com.naztuo.miaosha.bean.GoodsDetailVo;
...
public class GoodsController extends BaseController {
    ...
    @ResponseBody
    public RspMsg detail(HttpServletRequest request, HttpServletResponse response, Model model, MiaoshaUser user,
        ...
        return RspMsg.success(ResultStatus.SUCCESS.getMessage(), vo);
    }
}
